        ...
        <div class="register-container">
            ...
            <form action="{{ route('register.store') }}" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Entrez votre nom" value="{{ old('name') }}" required>
                    @error('name')
            ...
            <p class="mt-3 text-center">Vous avez déjà un compte? <a href="/login">Se connecter ici</a></p>
        </div>
    </div>
</body>
</html>
